$(function () {
    ...
    form_data.append("id_receiver", sessionStorage.getItem("id_user_login"));
    var alto_pantalla=$(window).height();
    var alto_header=$(".contenedor_header").height();
    $(".form.grid").height(alto_pantalla-alto_header-100);
    getUser(form_data);
    $(".btn_primario").on("click", function (e) {
        sessionStorage.removeItem("id_user_login");
        window.location.assign("index.html");
    });
    $(".btn_secundario").on("click", function (e) {
        sessionStorage.setItem("id_receiver",sessionStorage.getItem("id_user_login"));
    ...
    getNotificaciones(sessionStorage.getItem("id_user_login"));
});
